...
<div class="header navbar navbar-inverse ">
    ...
    <div class="navbar-inner">
        <div class="header-seperation">
            ...
            <!-- BEGIN LOGO -->
            <a href="index.html"><img src="/resources/img/logo.png" class="logo"  data-src="/resources/img/logo.png" data-src-retina="/resources/img/logo2x.png" width="106" height="92"/></a>
            <!-- END LOGO -->
            ...
            <div class="pull-right">
                <div class="chat-toggler">
                    ...
                    <div class="profile-pic">
                        <img alt="" src="/resources/img/profiles/avatar_small.jpg" data-src="/resources/img/profiles/avatar_small.jpg" data-src-retina="/resources/img/profiles/avatar_small2x.jpg" width="35" height="35" />
                    </div>
                </div>
                <ul class="nav quick-section ">
                    <li class="quicklinks">
